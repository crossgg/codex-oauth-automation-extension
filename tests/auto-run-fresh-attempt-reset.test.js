...
(async () => {
  ...
  assert.strictEqual(snapshot.currentState.gmailRegistrationMode, 'custom_pool', 'gmail registration mode should survive fresh-attempt reset');
  ...
  assert.strictEqual(snapshot.currentState.currentGmailCustomPoolAccountId, 'pool-1', 'gmail custom pool selection should survive fresh-attempt reset');
