(function attachManagedAliasUtils(root, factory) {
  ...
  function usesManagedAliasGeneration(provider = '', options = {}) {
    ...
    if (normalizedProvider === GMAIL_PROVIDER) {
      const gmailRegistrationMode = typeof options === 'string'
        ? options
        : options?.gmailRegistrationMode;
      return normalizeGmailRegistrationMode(gmailRegistrationMode) === GMAIL_REGISTRATION_MODE_ALIAS;
    }
